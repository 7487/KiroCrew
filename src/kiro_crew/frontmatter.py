...
def fold_block_scalar(
    ...
    *,
    ...
    if first is None:
        # No content line at all, so every line is a break and only keep-chomping has
        # anything to preserve. Measured against the parser: ``|+`` over one blank line
        # is one break, over two is two.
