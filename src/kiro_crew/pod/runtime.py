...
_SCENARIO_RE = re.compile(r"^[a-z0-9][a-z0-9._-]{0,60}$")
...
def is_scenario_ref(value: str) -> bool:
    ...
    if "/" in value or "\\" in value or os.sep in value:
        return False
    return bool(_SCENARIO_RE.match(value))
...
def resolve_seed_scenario(value: str) -> str:
    ...
    escape hatch, since a bare relative dir name lands here (see ``_SCENARIO_RE``).
    """
