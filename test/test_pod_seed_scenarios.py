...
class TestScenarioClassification:
    @pytest.mark.parametrize("value", ["rich", "minimal", "crons-active", "a", "x.y_z-1"])
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            "dir/sub",
            "dir\\sub",
            # Upper case is a path-ish typo rather than a fixture: every shipped
            # fixture name is lowercase, so treating this as a scenario would
            # produce a confusing "unknown scenario" for a real directory.
            "Rich",
        ],
    )
